...
|---|---|---|---|---|---|---|---|
| [A100 (2020)](https://images.nvidia.com/aem-dam/en-zz/Solutions/data-center/nvidia-ampere-architecture-whitepaper.pdf) | 40 | 108 | 1.5 | 192 (combined) | 40 | -- | -- |
...
We can expect this under-utilization to hinder performance when switching platforms, particularly for workloads that heavily depend on caches. The issue is reinforced by AMD's L1 cache being smaller than both the LDS and Nvidia's L1. As the [CINES porting and optimization guide](https://dci.dci-gitlab.cines.fr/webextranet/porting_optimization/index.html#guidelines) puts it:
